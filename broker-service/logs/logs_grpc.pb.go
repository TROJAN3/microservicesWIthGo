...
const (
	Logger_WriteLog_FullMethodName = "/logs.Logger/writeLog"
)
...
func (c *loggerClient) WriteLog(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogResponse, error) {
	...
	out := new(LogResponse)
	err := c.cc.Invoke(ctx, Logger_WriteLog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Logger_WriteLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Logger_WriteLog_FullMethodName,
	}
